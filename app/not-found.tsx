    ...
    <div className="relative min-h-screen w-full bg-[#080808] text-white flex flex-col items-center justify-center overflow-hidden px-6">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        <motion.span
          ...
          className="text-[40vw] font-black text-white/[0.03] leading-none tracking-tighter"
        >
          404
        </motion.span>
      </div>
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        >
          ...
          <span className="text-[9px] uppercase tracking-[0.5em] text-bloodred font-black">Error 404</span>
          <div className="w-10 h-[1px] bg-bloodred" />
        </motion.div>
        ...
        >
          This page doesn&apos;t exist or was removed. Don&apos;t get lost — the drop is waiting.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <span className="absolute inset-0 z-10 flex items-center justify-center gap-3 text-[#080808] opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-black uppercase tracking-[0.25em] text-[10px]">Back to Home →</span>
          </Link>
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden py-3 border-t border-white/5">
        ...
        >
          {Array(12).fill('WEAR IMPULSIVE // PAGE NOT FOUND // ').map((t, i) => (
